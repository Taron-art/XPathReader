...
namespace ARTX.XPathReader
{
    internal class XPathReaderEmitter
    {
        ...
        private static readonly string GeneratedCodeAttribute = $"GeneratedCodeAttribute(\"{typeof(XPathReaderGenerator).Assembly.GetName().Name}\", \"{typeof(XPathReaderGenerator).Assembly.GetName().Version}\")";
...
[
        ...
        {
            // Emit the namespace.
            MemberInfo? parent = xpathToGenerate.MethodInfo;
            ...
            writer.WriteLine($"[global::System.CodeDom.Compiler.{GeneratedCodeAttribute}]");
        ...
        private static void EmitXPathReader(XPathReaderDataToGenerate xPathToGenerate, XPathTree tree, IntendedTextWriterExtended writer)
        {
            ...
            ReadXmlEmitter emitter = new(tree);
